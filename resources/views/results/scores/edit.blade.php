...
@section('title', 'Edit Scores - Skulbase')
...
<div class="welcome-section">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2>Edit Scores</h2>
            <p class="text-muted mb-0">Bulk edit existing score entries</p>
        </div>
    ...
    <div class="card stat-card mb-4">
        <div class="card-body" style="padding: 24px;">
            ...
            <form method="GET" action="{{ route('results.scores.edit') }}" id="filterForm">
                <div class="row">
    ...
    @if($selectedExam && $selectedClass && $selectedSubject && $selectedAssessmentType)
        ...
        @else
            <form method="POST" action="{{ route('results.scores.update') }}">
                @csrf
                @method('PUT')
                ...
                <div class="card stat-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 style="font-weight: 600; color: #1a1a2e; margin: 0;">Edit Scores ({{ $students->count() }} students)</h5>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn" style="background: #4f9cf7; color: #fff; border-radius: 8px; padding: 10px 24px; font-weight: 500; border: none; cursor: pointer;">Update Scores</button>
                        </div>
                    </div>
                </div>
            </form>
    ...
    @else
        <div class="card stat-card">
            <div class="card-body" style="padding: 60px; text-align: center;">
                <p class="text-muted" style="margin: 0; font-size: 15px;">Please select an exam, class, subject, and assessment type above to load students for score editing.</p>
            </div>
        </div>
    @endif
</div>
