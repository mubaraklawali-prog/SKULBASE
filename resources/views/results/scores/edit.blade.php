...
<div class="welcome-section">
                ...
                <div class="sb-card sb-table-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="fw-semibold mb-0">Edit Scores ({{ $students->count() }} students)</h5>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="sb-btn sb-btn-primary">Update Scores</button>
                        </div>
                    </div>
                </div>
            </form>
    ...
    @else
        <div class="sb-card">
            <div class="card-body sb-empty-state">
                <p>Please select an exam, class, subject, and assessment type above to load students for score editing.</p>
            </div>
        </div>
    @endif
</div>
