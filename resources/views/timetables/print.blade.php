...
<head>
    ...
    <title>Timetable - {{ $selectedClass->name ?? '' }} {{ $selectedSection->name ?? '' }} - Skulbase</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .print-header .class-info strong {
            color: #333;
        }
        .print-actions {
            text-align: right;
...
<body>
    ...
    <div class="print-header">
        ...
        <div class="timetable-title">Weekly Class Timetable</div>
    ...
    <div class="footer">
        {{ $school->name ?? 'Skulbase' }} &mdash; Weekly Timetable &mdash; Generated on {{ now()->format('M d, Y \a\t h:i A') }}
    </div>
</body>
</html>
