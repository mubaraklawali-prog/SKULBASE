...
<body>
    <main class="login-card" role="main">
        ...
        <form method="POST" action="{{ route('affiliates.login.submit') }}" novalidate>
            @csrf
        ...
        <div class="links">
            New to the program? <a href="{{ route('affiliates.register') }}">Become an affiliate</a>
        </div>

        <div class="links">
            <a href="{{ route('login') }}">Sign in as a school user</a>
        </div>
    </main>
</body>
