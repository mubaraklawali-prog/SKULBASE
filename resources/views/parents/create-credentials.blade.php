...
@section('title', 'Parent Login Credentials - Skulbase')
...
<div class="welcome-section">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Login account created for {{ $parent->full_name }}</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('parents.show', $parent) }}" class="sb-btn sb-btn-primary">
                View Parent Profile
            </a>
...
<script>
    ...
    function printCredentials() {
        ...
        printWindow.document.write(`
            ...
            <html>
            <head>
                <title>Parent Credentials - {{ $parent->full_name }}</title>
                <style>
            ...
            <body>
                ...
                <p class="subtitle">{{ $parent->full_name }} | {{ $parent->school->name ?? '' }}</p>
