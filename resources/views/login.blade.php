...
<body>
    <main class="login-card" role="main">
        ...
        <form method="POST" action="{{ route('login') }}" novalidate>
            ...
            <div class="mb-3">
                <label for="alt-login-email" class="sb-form-label">Email</label>
                <input type="email" id="alt-login-email" name="email" class="sb-form-input" value="{{ old('email') }}" required autofocus autocomplete="email">
                @error('email')
            ...
            <div class="mb-3">
                <label for="alt-login-password" class="sb-form-label">Password</label>
                <input type="password" id="alt-login-password" name="password" class="sb-form-input" required autocomplete="current-password">
                @error('password')
                    <div class="sb-form-error" role="alert">{{ $message }}</div>
                @enderror
            </div>
