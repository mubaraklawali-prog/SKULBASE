...
@section('title', 'Teacher Login Credentials - Skulbase')
...
<div class="welcome-section">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Login account created for {{ $teacher->full_name }}</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('teachers.show', $teacher) }}" class="sb-btn sb-btn-primary">
...
<script>
    ...
    function printCredentials() {
        ...
        printWindow.document.write(`
            ...
            <html>
            <head>
                <title>Teacher Credentials - {{ $teacher->full_name }}</title>
                <style>
            ...
            <body>
                ...
                <p class="subtitle">{{ $teacher->full_name }} | {{ $teacher->school->name ?? '' }}</p>
