                        ...
                        @forelse($paidStudents as $index => $student)
                            <tr>
                                ...
                                <td style="padding: 14px 20px;">
                                    <code style="background: #f0f2f5; padding: 2px 8px; border-radius: 4px; font-size: 12px;">{{ $student->admission_number }}</code>
                                </td>
                                <td style="padding: 14px 20px; color: #6c757d;">{{ $student->schoolClass->name ?? '—' }}</td>
                                <td style="padding: 14px 20px; text-align: right;">
                                    <a href="{{ route('fees.student', $student) }}" class="btn btn-sm" style="background: #d1e7dd; color: #0f5132; border-radius: 6px; padding: 6px 12px; font-size: 13px; font-weight: 500; text-decoration: none;">View Profile</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
