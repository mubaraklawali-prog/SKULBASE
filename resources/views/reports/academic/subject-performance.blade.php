...
<div class="welcome-section">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('reports.export.subject-performance.csv', request()->query()) }}" class="sb-btn sb-btn-primary">Export CSV</a>
            <a href="{{ route('reports.export.subject-performance.pdf', request()->query()) }}" class="sb-btn sb-btn-danger">Export PDF</a>
    ...
    @else
        <div class="card stat-card">
            <div class="card-body sb-empty-state">
                <p style="margin: 0; font-size: 15px;">No subject performance data available. Please select an exam.</p>
            </div>
        </div>
    @endif
</div>
