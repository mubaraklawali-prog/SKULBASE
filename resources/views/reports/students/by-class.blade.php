                    ...
                    <tbody>
                        ...
                        @forelse($byClass as $index => $class)
                            <tr>
                                ...
                                <td style="font-weight: 600;">{{ $class->students_count }}</td>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div style="flex: 1; height: 8px; background: #e9ecef; border-radius: 4px; overflow: hidden;">
                                            <div style="height: 100%; width: {{ ($class->students_count / $maxCount) * 100 }}%; background: var(--primary); border-radius: 4px;"></div>
                                        </div>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="sb-empty-state">No classes found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
