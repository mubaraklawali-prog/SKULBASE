...
<body>
    ...
    <main class="sb-main-content">
        <div class="sb-content-wrapper">
            ...
            @if (request()->attributes->get('subscription_warning'))
                @php $subWarning = request()->attributes->get('subscription_warning'); @endphp
                <div class="sb-subscription-banner">
                    ...
                    <a href="{{ route('school.subscription.index') }}" class="sb-btn sb-btn-sm sb-btn-primary">
                        Renew Now
                    </a>
                </div>
            @endif
