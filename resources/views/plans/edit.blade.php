...
@section('title', 'Edit Plan - Skulbase')

@section('content')
<div class="welcome-section">
    <div class="mb-4">
        <h2>Edit Plan</h2>
        <p class="text-muted mb-0">Update {{ $plan->name }} details</p>
    </div>
            ...
            <form method="POST" action="{{ route('plans.update', $plan) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        >
                            <option value="0" {{ old('is_unlimited', (int) $plan->is_unlimited) === 0 ? 'selected' : '' }}>No</option>
                            <option value="1" {{ old('is_unlimited', (int) $plan->is_unlimited) === 1 ? 'selected' : '' }}>Yes</option>
                        </select>
                        @error('is_unlimited')
                            <div class="sb-form-error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select
                            ...
                            required
                        >
                            <option value="1" {{ old('is_active', (int) $plan->is_active) === 1 ? 'selected' : '' }}>Active</option>
                            <option value="0" {{ old('is_active', (int) $plan->is_active) === 0 ? 'selected' : '' }}>Inactive</option>
                        </select>
                        @error('is_active')
                            <div class="sb-form-error">{{ $message }}</div>
                        @enderror
