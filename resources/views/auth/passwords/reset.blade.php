    ...
    <main class="login-card" role="main">
        ...
        <form method="POST" action="{{ route('password.update') }}" novalidate>
            ...
            <div class="mb-3">
                ...
                <input type="email" id="reset-email" name="email" class="sb-form-input @error('email') is-invalid @enderror"
            ...
            <div class="mb-3">
                ...
                <input type="password" id="reset-password" name="password" class="sb-form-input @error('password') is-invalid @enderror"
