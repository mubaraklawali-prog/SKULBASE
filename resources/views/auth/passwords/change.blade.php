    ...
    <main class="login-card" role="main">
        ...
        <form method="POST" action="{{ route('password.change.submit') }}" novalidate>
            ...
            <div class="mb-3">
                ...
                <input type="password" id="change-current-password" name="current_password" class="sb-form-input @error('current_password') is-invalid @enderror"
            ...
            <div class="mb-3">
                ...
                <input type="password" id="change-new-password" name="password" class="sb-form-input @error('password') is-invalid @enderror"
