    ...
    <main class="login-card" role="main">
        ...
        <form method="POST" action="{{ route('register') }}" novalidate>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="reg-name" name="name" class="sb-form-input" value="{{ old('name') }}" required autofocus autocomplete="name">
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="email" id="reg-email" name="email" class="sb-form-input" value="{{ old('email') }}" required autocomplete="email">
                @error('email')
                    <div class="sb-form-error" role="alert">{{ $message }}</div>
                @enderror
            </div>
