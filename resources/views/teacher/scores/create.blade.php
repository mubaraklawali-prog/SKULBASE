...
<div class="welcome-section">
    <div class="sb-section-header">
        ...
        <a href="{{ route('teacher.scores.history') }}" class="sb-btn sb-btn-outline-secondary">Score History</a>
    </div>
    ...
    <div class="sb-card mb-4">
        <div class="card-body p-3">
            ...
            <form method="GET" action="{{ route('teacher.scores.create') }}" id="filterForm">
                <div class="row">
                ...
                <div class="sb-card sb-table-card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('teacher.dashboard') }}" class="sb-btn sb-btn-outline-secondary">Cancel</a>
