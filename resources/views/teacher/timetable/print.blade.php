...
<head>
    ...
    <title>My Schedule - {{ $teacher->full_name }} - Skulbase</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .print-header .teacher-info {
            font-size: 14px;
            color: #6c757d;
        }
        .print-header .teacher-info strong {
            color: #333;
        }
        .print-actions {
            text-align: right;
...
<body>
    ...
    <div class="print-header">
        ...
        <div class="timetable-title">Teacher Weekly Schedule</div>
        <div class="teacher-info">
            Teacher: <strong>{{ $teacher->full_name ?? '—' }}</strong>
                            ...
                            @elseif($entry)
                                <div class="lesson-cell">
                                    ...
                                    <div class="class-section">
                                        {{ $entry->schoolClass->name ?? '' }}{{ $entry->section ? ' — ' . $entry->section->name : '' }}
                                    </div>
                                    @if($entry->notes)
    ...
    <div class="footer">
        {{ $school->name ?? 'Skulbase' }} &mdash; Teacher Weekly Schedule &mdash; Generated on {{ now()->format('M d, Y \a\t h:i A') }}
    </div>
</body>
</html>
