...
<head>
    ...
    <title>Affiliate Login - Skulbase</title>
...
<body>
    <main class="login-card" role="main">
        ...
        <form method="POST" action="<?php echo e(route('affiliates.login.submit')); ?>" novalidate>
            <?php echo csrf_field(); ?>

            <div class="mb-3">
                <label for="login-email" class="sb-form-label">Email</label>
                <input type="email" id="login-email" name="email" class="sb-form-input <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <input type="password" id="login-password" name="password" class="sb-form-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="links">
            New to the program? <a href="<?php echo e(route('affiliates.register')); ?>">Become an affiliate</a>
        </div>

        <div class="links">
            <a href="<?php echo e(route('login')); ?>">Sign in as a school user</a>
        </div>
    </main>
</body>

</html>
<?php /**PATH C:\Users\USER\OneDrive\Desktop\SKILL\APP School\School Project\schoolproject\school-system\resources\views/affiliate/login.blade.php ENDPATH**/ ?>