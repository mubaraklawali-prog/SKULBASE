        ...
        <div class="sb-dropdown" id="profileDropdown">
            <button class="sb-topbar-profile" aria-expanded="false" aria-controls="profileDropdownMenu" aria-haspopup="true" id="profileDropdownBtn">
                ...
                <span class="sb-topbar-profile-info">
                    <span class="sb-topbar-profile-name"><?php echo e($currentUser->name ?? 'User'); ?></span>
                    <span class="sb-topbar-profile-role <?php echo e($roleBadgeClass); ?>"><?php echo e($schoolName ? $schoolName . ' · ' . $roleLabel : $roleLabel); ?></span>
                </span>
            ...
            <div class="sb-dropdown-menu" id="profileDropdownMenu" role="menu" aria-labelledby="profileDropdownBtn">
                <a href="<?php echo e(route('dashboard')); ?>" class="sb-dropdown-item" role="menuitem">
                ...
                <a href="<?php echo e(route('password.change')); ?>" class="sb-dropdown-item" role="menuitem">
...
<?php /**PATH C:\Users\USER\OneDrive\Desktop\SKILL\APP School\School Project\schoolproject\school-system\resources\views/layouts/partials/_navbar.blade.php ENDPATH**/ ?>