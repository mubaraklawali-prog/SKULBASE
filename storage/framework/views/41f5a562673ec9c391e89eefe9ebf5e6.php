...
<div class="welcome-section">
    <div class="sb-section-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div>
            ...
            <?php elseif($affiliate->isSuspended()): ?>
...
<div class="card stat-card mb-4">
    <div class="card-body">
        ...
        <p class="text-muted small mb-3">Share this link — when a school registers through it and pays, you earn a
            <?php echo e($affiliate->effectiveCommissionRate()); ?>% commission on the first payment and every renewal for 12 months.</p>
        <div class="d-flex gap-2 flex-wrap align-items-center">
            <input type="text" id="referralLink" class="sb-form-input" style="max-width: 560px;" readonly
                   value="<?php echo e($affiliate->referralUrl()); ?>">
            <button type="button" class="sb-btn sb-btn-primary sb-btn-sm" id="copyLinkBtn" onclick="copyReferralLink()">Copy Link</button>
            <button type="button" class="sb-btn sb-btn-outline-primary sb-btn-sm" onclick="navigator.clipboard.writeText('<?php echo e($affiliate->code); ?>').then(() => alert('Referral code copied: <?php echo e($affiliate->code); ?>'))">Copy Code</button>
            <span class="sb-form-help mb-0">Your code: <strong><?php echo e($affiliate->code); ?></strong></span>
        </div>
    </div>
</div>
...
<div class="row g-3 g-md-4 mb-4">
    <div class="col-6 col-md-4 col-lg-3">
        <div class="card stat-card h-100">
            <div class="card-body">
                <p class="stat-number"><?php echo e(number_format($stats['total_clicks'])); ?></p>
    ...
    <div class="col-6 col-md-4 col-lg-3">
        <div class="card stat-card h-100">
            <div class="card-body">
                <p class="stat-number"><?php echo e(number_format($stats['referred_schools'])); ?></p>
    ...
    <div class="col-6 col-md-4 col-lg-3">
        <div class="card stat-card h-100">
            <div class="card-body">
                <p class="stat-number"><?php echo e(number_format($stats['trial_referrals'])); ?></p>
    ...
    <div class="col-6 col-md-4 col-lg-3">
        <div class="card stat-card h-100">
            <div class="card-body">
                <p class="stat-number"><?php echo e(number_format($stats['paying_referrals'])); ?></p>
    ...
    <div class="col-6 col-md-4 col-lg-3">
        <div class="card stat-card h-100">
            <div class="card-body">
                <p class="stat-number">₦<?php echo e(number_format($stats['pending_commission'], 2)); ?></p>
    ...
    <div class="col-6 col-md-4 col-lg-3">
        <div class="card stat-card h-100">
            <div class="card-body">
                <p class="stat-number">₦<?php echo e(number_format($stats['approved_commission'], 2)); ?></p>
    ...
    <div class="col-6 col-md-4 col-lg-3">
        <div class="card stat-card h-100">
            <div class="card-body">
                <p class="stat-number">₦<?php echo e(number_format($stats['paid_commission'], 2)); ?></p>
    ...
    <div class="col-6 col-md-4 col-lg-3">
        <div class="card stat-card h-100">
            <div class="card-body">
                <p class="stat-number" style="color: var(--success);">₦<?php echo e(number_format($stats['total_earned'], 2)); ?></p>
...
<div class="row g-4">
                                ...
                                <?php $__currentLoopData = $referrals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $referral): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            ...
                                            <?php if($referral->referred_email): ?>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span class="sb-badge <?php echo e($badge); ?>"><?php echo e(ucfirst($referral->status)); ?></span>
                                        </td>
                                ...
                                <?php $__currentLoopData = $commissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            ...
                                            <br><small class="text-muted"><?php echo e(ucwords(str_replace('_', ' ', $commission->type))); ?> @ <?php echo e($commission->formattedRate()); ?></small>
                                        </td>
                                        <td><?php echo e($commission->paid_period); ?></td>
    ...
    <div class="col-lg-4">
        ...
        <div class="card action-card mb-4">
            ...
            <div class="card-body">
                <?php if($affiliate->isActive()): ?>
                    <form method="POST" action="<?php echo e(route('affiliate.payouts.request')); ?>" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            ...
                            <input type="number" id="payout-amount" name="amount" class="sb-form-input"
                                   min="0.01" step="0.01" value="<?php echo e(old('amount', $stats['approved_commission'] + $stats['paid_commission'] > 0 ? $stats['approved_commission'] : '')); ?>"
                                   required>
                            <small class="sb-form-help">Minimum payout: ₦<?php echo e(number_format($minPayout, 2)); ?></small>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" id="payout-method" name="method" class="sb-form-input"
                                   value="<?php echo e(old('method', $affiliate->payout_method)); ?>" placeholder="e.g. Bank Transfer" required>
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea id="payout-details" name="payout_details" class="sb-form-textarea" rows="3"
                                      placeholder="Account name, number, bank..."><?php echo e(old('payout_details')); ?></textarea>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\OneDrive\Desktop\SKILL\APP School\School Project\schoolproject\school-system\resources\views/affiliate/dashboard.blade.php ENDPATH**/ ?>