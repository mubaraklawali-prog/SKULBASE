<?php $__env->startSection('title', 'Edit School - Skulbase'); ?>

<?php $__env->startSection('content'); ?>
<div class="welcome-section">
    <div class="mb-4">
        <h2>Edit School</h2>
        <p class="text-muted mb-0">Update <?php echo e($school->name); ?> details</p>
    </div>

    <div class="card stat-card">
        <div class="card-body" style="padding: 32px;">
            <form method="POST" action="<?php echo e(route('schools.update', $school)); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            name="email"
                            id="email"
                            value="<?php echo e(old('email', $school->email)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            name="phone"
                            id="phone"
                            value="<?php echo e(old('phone', $school->phone)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                            rows="2"
                        ><?php echo e(old('address', $school->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            placeholder="City"
                            class="sb-form-input <?php $__errorArgs = ['city'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            name="state"
                            id="state"
                            value="<?php echo e(old('state', $school->state)); ?>"
                            placeholder="State"
                            class="sb-form-input <?php $__errorArgs = ['state'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            name="country"
                            id="country"
                            value="<?php echo e(old('country', $school->country)); ?>"
                            placeholder="Country"
                            class="sb-form-input <?php $__errorArgs = ['country'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\OneDrive\Desktop\SKILL\APP School\School Project\schoolproject\school-system\resources\views/schools/edit.blade.php ENDPATH**/ ?>