<?php $__env->startSection('title', 'Parent Login Credentials - Skulbase'); ?>
...
<div class="welcome-section">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Login account created for <?php echo e($parent->full_name); ?></p>
        </div>
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('parents.show', $parent)); ?>" class="sb-btn sb-btn-primary">
                View Parent Profile
            </a>
            ...
            <div class="card stat-card mb-4" id="credentials-card">
                <div class="card-body" style="padding: 32px;">
                    <div style="text-align: center; margin-bottom: 20px;">
                        ...
                        <p style="color: #6c757d; font-size: 14px; margin: 0;">Share these credentials with the parent</p>
                    </div>
                    ...
                    <div style="background: #fff3cd; border-radius: 8px; padding: 12px 16px; margin-bottom: 16px;">
                        <p style="margin: 0; font-size: 13px; color: #664d03;">
                            <strong>Important:</strong> The parent will be required to change their password on first login. Share these credentials through a secure channel.
                        </p>
                    </div>
...
<script>
    ...
    function printCredentials() {
        ...
        printWindow.document.write(`
            ...
            <html>
            <head>
                <title>Parent Credentials - <?php echo e($parent->full_name); ?></title>
                <style>
            ...
            <body>
                <h2>Skulbase - Parent Login Credentials</h2>
                <p class="subtitle"><?php echo e($parent->full_name); ?> | <?php echo e($parent->school->name ?? ''); ?></p>
                ...
                <div class="warning">
                    <strong>Note:</strong> The parent will be required to change their password on first login.
                </div>
            </body>
            </html>
        `);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\OneDrive\Desktop\SKILL\APP School\School Project\schoolproject\school-system\resources\views/parents/create-credentials.blade.php ENDPATH**/ ?>