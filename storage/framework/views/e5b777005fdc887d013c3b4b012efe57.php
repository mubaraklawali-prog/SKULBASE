...
<head>
    ...
    <title>Change Password - Skulbase</title>
...
<body>
    <main class="login-card" role="main">
        <h1>SkulBase</h1>
        <p class="subtitle">Welcome! Please change your password before continuing.</p>
        ...
        <form method="POST" action="<?php echo e(route('password.change.submit')); ?>" novalidate>
            <?php echo csrf_field(); ?>

            <div class="mb-3">
                <label for="change-current-password" class="sb-form-label">Current Password</label>
                <input type="password" id="change-current-password" name="current_password" class="sb-form-input <?php $__errorArgs = ['current_password'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                <label for="change-new-password" class="sb-form-label">New Password</label>
                <input type="password" id="change-new-password" name="password" class="sb-form-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                <label for="change-confirm-password" class="sb-form-label">Confirm New Password</label>
                <input type="password" id="change-confirm-password" name="password_confirmation" class="sb-form-input"
                       required autocomplete="new-password">
            </div>
...
<?php /**PATH C:\Users\USER\OneDrive\Desktop\SKILL\APP School\School Project\schoolproject\school-system\resources\views/auth/passwords/change.blade.php ENDPATH**/ ?>