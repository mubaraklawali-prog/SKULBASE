    ...
    <div class="ds-hero ds-hero--platform">
        ...
        <div class="ds-hero-content">
            <div class="ds-hero-text">
                <p class="ds-hero-greeting"><?php echo e($greeting); ?></p>
                <h1 class="ds-hero-title">Welcome back, <?php echo e($user->name ?? 'Admin'); ?></h1>
...
<?php elseif($school): ?>
    <div class="ds-hero ds-hero--school">
        ...
        <div class="ds-hero-content">
            <div class="ds-hero-text">
                <p class="ds-hero-greeting"><?php echo e($greeting); ?></p>
                <h1 class="ds-hero-title"><?php echo e($school->name); ?></h1>
                <?php if($school->motto): ?>
                    <p class="ds-hero-motto">"<?php echo e($school->motto); ?>"</p>
                <?php endif; ?>
                <p class="ds-hero-subtitle">Welcome back, <?php echo e($user->name); ?>. Here's your school overview.</p>
                <div class="ds-hero-chips">
                    <?php if($subscription): ?>
                        <?php $sub = $subscription; ?>
                        <span class="ds-hero-chip ds-hero-chip--badge ds-hero-chip--<?php echo e($sub->status); ?>">
                            <span class="ds-hero-chip-dot ds-hero-chip-dot--<?php echo e($sub->is_trial ? 'yellow' : ($sub->isActive() ? 'green' : 'red')); ?>"></span>
                            <?php if($sub->is_trial): ?> Trial
                            <?php elseif($sub->isActive()): ?> <?php echo e($sub->plan->name ?? 'Active'); ?>

                            <?php elseif($sub->isGrace()): ?> Grace Period
                            <?php else: ?> <?php echo e(ucfirst($sub->status)); ?>

                            <?php endif; ?>
                        </span>
                    <?php endif; ?>
                    <?php if($schoolSetting && $schoolSetting->current_session): ?>
                        <span class="ds-hero-chip">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                            <?php echo e($schoolSetting->current_session); ?> &middot; <?php echo e($schoolSetting->current_term ?? ''); ?>
...
<?php else: ?>
    <div class="ds-hero">
        ...
        <div class="ds-hero-content">
            <div class="ds-hero-text">
                <p class="ds-hero-greeting"><?php echo e($greeting); ?></p>
                <h1 class="ds-hero-title">Welcome back, <?php echo e($user->name ?? 'User'); ?></h1>
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\OneDrive\Desktop\SKILL\APP School\School Project\schoolproject\school-system\resources\views/components/dashboard/welcome-banner.blade.php ENDPATH**/ ?>