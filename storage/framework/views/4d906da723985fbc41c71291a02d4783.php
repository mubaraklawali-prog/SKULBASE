    ...
    <nav class="sb-sidebar-nav" aria-label="Main navigation">
        <ul class="sb-sidebar-menu">
            ...
            <li class="sb-sidebar-item">
                <a class="sb-sidebar-link <?php echo e(request()->routeIs('dashboard') || request()->routeIs('affiliate.dashboard') ? 'active' : ''); ?>" href="<?php echo e($userRole === 'affiliate' ? route('affiliate.dashboard') : route('dashboard')); ?>">
            ...
            <?php if($isSuperAdmin): ?>
                ...
                <li class="sb-sidebar-item">
                    <a class="sb-sidebar-link <?php echo e(request()->routeIs('affiliates.*') ? 'active' : ''); ?>" href="<?php echo e(route('affiliates.index')); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
                        <span>Affiliates</span>
                    </a>
                </li>
                <li class="sb-sidebar-item">
                    <a class="sb-sidebar-link <?php echo e(request()->routeIs('payouts.*') ? 'active' : ''); ?>" href="<?php echo e(route('payouts.index')); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
                        <span>Payouts</span>
                    </a>
                </li>
            ...
            <?php if($userRole === 'affiliate'): ?>
                <li class="sb-sidebar-section">Affiliate</li>
                <li class="sb-sidebar-item">
                    <a class="sb-sidebar-link <?php echo e(request()->routeIs('affiliate.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('affiliate.dashboard')); ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
