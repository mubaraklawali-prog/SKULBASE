    ...
    <main class="login-card" role="main">
        ...
        <?php if(session('pending_approval')): ?>
            <div class="sb-flash-warning" role="alert">
                <?php echo e(session('pending_approval')); ?>

            </div>
        <?php endif; ?>

        <?php if(session('rejected')): ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="links">
            <a href="<?php echo e(route('school.register')); ?>">Register your school</a>
        </div>
...
<?php /**PATH C:\Users\USER\OneDrive\Desktop\SKILL\APP School\School Project\schoolproject\school-system\resources\views/auth/login.blade.php ENDPATH**/ ?>