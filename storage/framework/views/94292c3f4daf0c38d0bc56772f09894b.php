<?php $__env->startSection('title', 'Results Dashboard - Skulbase'); ?>
...
<div class="welcome-section">
        ...
        <div class="col-md-4 mb-3">
            <div class="card stat-card h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        <p class="stat-number sb-stat-number-excused"><?php echo e($totalExams); ?></p>
        ...
        <div class="col-md-4 mb-3">
            <div class="card stat-card h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        <p class="stat-number sb-stat-number-late"><?php echo e($totalAssessmentTypes); ?></p>
        ...
        <div class="col-md-4 mb-3">
            <div class="card stat-card h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        <p class="stat-number sb-stat-number-present"><?php echo e($totalGradingRules); ?></p>
    ...
    <div class="row mb-4">
        <div class="col-md-4 mb-3">
            <div class="card stat-card h-100">
                <div class="card-body text-center p-4">
                    <p class="stat-number sb-stat-number-present"><?php echo e($activeExams); ?></p>
        ...
        <div class="col-md-4 mb-3">
            <div class="card stat-card h-100">
                <div class="card-body text-center p-4">
                    <p class="stat-number sb-stat-number-present"><?php echo e($activeAssessmentTypes); ?></p>
        ...
        <div class="col-md-4 mb-3">
            <div class="card stat-card h-100">
                <div class="card-body text-center p-4">
                    <p class="stat-number <?php echo e($totalPercentage == 100 ? 'sb-stat-number-present' : 'sb-stat-number-absent'); ?>"><?php echo e(number_format($totalPercentage, 1)); ?>%</p>
                            ...
                            <table class="table table-hover mb-0 sb-table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $recentExams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="fw-medium"><?php echo e($exam->name); ?></td>
                                            <td class="text-muted"><?php echo e($exam->term ?? '—'); ?></td>
                                            <td class="text-muted"><?php echo e($exam->session ?? '—'); ?></td>
                                            <td class="text-muted small">
                                                <?php echo e($exam->start_date ? $exam->start_date->format('M d') : '—'); ?>

                                                <?php echo e($exam->end_date ? ' - ' . $exam->end_date->format('M d, Y') : ''); ?>
            ...
            <div class="card stat-card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <a href="<?php echo e(route('results.assessment-types.index')); ?>" class="action-link">
                        ...
                        <a href="<?php echo e(route('results.exams.index')); ?>" class="action-link">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                            Exams
                        </a>
                        <a href="<?php echo e(route('results.grading-systems.index')); ?>" class="action-link">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\OneDrive\Desktop\SKILL\APP School\School Project\schoolproject\school-system\resources\views/results/dashboard.blade.php ENDPATH**/ ?>