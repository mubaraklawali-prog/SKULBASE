...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Error'); ?> — SkulBase</title>
    <style>
...
<body>
    <div class="error-page">
        ...
        <div class="brand">
            <a href="<?php echo e(url('/')); ?>">SkulBase</a> — School Management System
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\USER\OneDrive\Desktop\SKILL\APP School\School Project\schoolproject\school-system\resources\views/errors/layout.blade.php ENDPATH**/ ?>